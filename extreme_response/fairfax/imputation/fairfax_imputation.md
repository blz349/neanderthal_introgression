...
```bash
cd /well/jknight/shiyao/data/fairfax
/apps/well/plink/1.90b3/plink --bfile extreme_response --noweb --freq --out imputation/hrc_check/extreme_response
```

The script below was then submitted to the cluster to check the PLINK file against the HRC reference panel, and is saved under: /well/jknight/shiyao/data/fairfax/imputation/hrc_check/hrc_check_all.sh
...
#$ -P jknight.prjc
#$ -q short.qc
#$ -o /well/jknight/shiyao/data/fairfax/imputation/hrc_check/hrc_check_stdout.log 
#$ -e /well/jknight/shiyao/data/fairfax/imputation/hrc_check/hrc_check_stderr.log
#$ -pe shmem 2
...
perl /well/jknight/shiyao/data/fairfax/imputation/hrc_check/HRC-1000G-check-bim.pl \
-b /well/jknight/shiyao/data/fairfax/extreme_response.bim \
-f /well/jknight/shiyao/data/fairfax/imputation/hrc_check/extreme_response.frq \
-r /well/jknight/shiyao/data/fairfax/imputation/hrc_check/HRC.r1-1.GRCh37.wgs.mac5.sites.tab \
-h
...
Next, the SNPs identified was updated or removed using the script below, which is saved under: /well/jknight/shiyao/data/fairfax/imputation/Run-plink/Run-plink-edited.sh  
...
#$ -P jknight.prjc
#$ -q short.qc
#$ -o /well/jknight/shiyao/data/fairfax/imputation/Run-plink/hrc_imp_stdout.log
#$ -e /well/jknight/shiyao/data/fairfax/imputation/Run-plink/hrc_imp_stderr.log
#$ -pe shmem 1
...
After imputation, the files downloaded consist of a single bgzipped vcf file per chromosome. The info score (confidence) and  MAF was first exported using the following script, which is saved under: /well/jknight/shiyao/data/fairfax/imputation/info_freq/info_freq.sh
...
#$ -P jknight.prjc
#$ -q short.qc
#$ -o /well/jknight/shiyao/data/fairfax/imputation/info_freq/info_freq_stdout.log
#$ -e /well/jknight/shiyao/data/fairfax/imputation/info_freq/info_freq_stderr.log
#$ -pe shmem 1
...
for P in {1..22} ; do /apps/well/vcftools/16102015/bin/vcftools --gzvcf /well/jknight/shiyao/data/fairfax/imputation/fairfax432.vcfs/${P}.vcf.gz --get-INFO INFO --out chr${P} ; done

for P in {1..22} ; do /apps/well/vcftools/16102015/bin/vcftools --gzvcf /well/jknight/shiyao/data/fairfax/imputation/fairfax432.vcfs/${P}.vcf.gz --freq --out chr${P} ; done
...
# Load MAF data
freq.files <- list.files(path="/well/jknight/shiyao/data/fairfax/imputation/", pattern="*.frq")
freq.files <- paste("/well/jknight/shiyao/data/fairfax/imputation/", freq.files, sep="")
...
info.files <- list.files(path="/well/jknight/shiyao/data/fairfax/imputation/info_freq/", pattern="*.INFO")
info.files <- paste("/well/jknight/shiyao/data/fairfax/imputation/info_freq/", info.files, sep="")
info <- list()
for (i in 1:22){
...
pdf("/well/jknight/shiyao/data/fairfax/imputation/Imputation_infoscore.pdf", onefile = TRUE, useDingbats = FALSE)
...
pdf("/well/jknight/shiyao/data/fairfax/imputation/Imputation_infoscore_MAF.pdf", onefile = TRUE, useDingbats = FALSE)
...
The script below (saved under: /well/jknight/shiyao/data/fairfax/imputation/info_0.9/imp_filter/imp_filter.sh) was submited to the cluster to keep only calls with an info score > 0.9 and convert to Oxford format:
...
#$ -P jknight.prjc
#$ -q short.qc
#$ -o /well/jknight/shiyao/data/fairfax/imputation/info_0.9/imp_filter_432_stdout.log
#$ -e -e /well/jknight/shiyao/data/fairfax/imputation/info_0.9/imp_filter_432_stderr.log
#$ -pe shmem 1
...
for P in {1..22} ; do /apps/well/bcftools/1.3/bin/bcftools view -Ou -i 'INFO>0.9' /well/jknight/shiyao/data/fairfax/imputation/fairfax432.vcfs/${P}.vcf.gz | /apps/well/bcftools/1.3/bin/bcftools convert --tag GP -g ${P}.imputed.filtered ; done
...
# Genotyping coverage
extr_resp.bim <- read.delim("/well/jknight/shiyao/data/fairfax/extreme_response.bim", header=FALSE)
extr_resp.bim <- extr_resp.bim[extr_resp.bim$V1 %in% 1:22, ]
extr_resp.bim$V1 <- as.factor(extr_resp.bim$V1)

pdf("/well/jknight/shiyao/data/fairfax/imputation/Genotyping_coverage.pdf", onefile = TRUE, useDingbats = FALSE)
...
pdf("/well/jknight/shiyao/data/fairfax/imputation/Genotyping_coverage2.pdf", onefile = TRUE, useDingbats = FALSE)
...
for(c in 1:22){
  imputed.data <- read.delim(paste("/well/jknight/shiyao/data/fairfax/imputation/info_freq/chr", c, ".INFO", sep=""), header=TRUE, stringsAsFactors=F)
  n.imputed[c, 1] <- nrow(imputed.data)
}

n.infofilter_0.9 <- matrix(NA, nrow=22, ncol=1)
for (c in 1:22){
  infofilter_0.9.bim <- read.delim(paste("/well/jknight/shiyao/data/fairfax/imputation/info_0.9/imp_filter/", c, ".imputed.filtered.bim", sep=""), header=FALSE)
  n.infofilter_0.9[c, 1] <- nrow(infofilter_0.9.bim)
}

n.filtered_0.9 <- matrix(NA, nrow=22, ncol=1)
filtered_0.9.bim <- read.delim("/well/jknight/shiyao/data/fairfax/imputation/info_0.9/genotyping_for_eqtl.bim", header=FALSE)
for (c in 1:22){
...
noLD_0.9.bim <- read.delim("/well/jknight/shiyao/data/fairfax/imputation/info_0.9/fairfax_eqtl_genotyping_NoLongRangeLD.bim", header=FALSE)
for (c in 1:22){
...
pdf("/well/jknight/shiyao/data/fairfax/imputation/Imputation_overview.pdf", height=5, width=8)
ggplot(df.melt, aes(Chromosome, value, fill=variable)) +
...
# Imputation coverage
bim.files <- list.files(path="/well/jknight/shiyao/data/fairfax/imputation/info_0.9/imp_filter/",
                        pattern="*.imputed.filtered.bim")
bim.files <- paste("/well/jknight/shiyao/data/fairfax/imputation/info_0.9/imp_filter/",
                    bim.files, sep="")
bims <- list()
for (i in 1:22){
...
pdf("/well/jknight/shiyao/data/fairfax/imputation/GenotypingvsImputationCoverage.pdf", height=5, width=15)
